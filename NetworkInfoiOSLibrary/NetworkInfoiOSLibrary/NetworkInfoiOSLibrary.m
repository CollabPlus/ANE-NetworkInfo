...
//
//  NetworkInfoiOSLibrary.m
//  NetworkInfoiOSLibrary
//
//  Modified by Gnanaprakash on 31/01/15.
//  Copyright (c) 2015 Knobay.com. All rights reserved.
//
...
FREObject findInterfaces(FREContext ctx, void* funcData, uint32_t argc, FREObject argv[])
{
    ...
    for (ifa = ifAddrStruct; ifa != NULL; ifa = ifa->ifa_next)
    {
            ...
            
        {
            ...
            FRENewObjectFromUTF8((uint32_t)strlen(ifa->ifa_name), (const uint8_t*)ifa->ifa_name, &NetworkInterfaceArray[0]);
            ...
            FRENewObjectFromUTF8((uint32_t)strlen(ifa->ifa_name), (const uint8_t*)ifa->ifa_name, &NetworkInterfaceArray[1]);
